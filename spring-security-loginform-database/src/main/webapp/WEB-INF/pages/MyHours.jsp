			...
			<div id="menu2" class="tab-pane fade" style="height: 500px">
				<div class="dropdown">
					...
					<ul class="dropdown-menu btn-block">
						<li><a href="#"	onClick="document.getElementById('reportframe').src='http://birt-reporter.mybluemix.net/frameset?__report=query40.rptdesign'">Empleados	con mas de 40hs</a></li>
						<li><a href="#"	onClick="document.getElementById('reportframe').src='http://birt-reporter.mybluemix.net/frameset?__report=multiProjects.rptdesign'">Empleados con mas de 1 proyecto</a></li>
						<li><a href="#"	onClick="document.getElementById('reportframe').src='http://birt-reporter.mybluemix.net/frameset?__report=holidays.rptdesign'">Empleados sin los feriados cargados</a></li>
					</ul>
				</div>
